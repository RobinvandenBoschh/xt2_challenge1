...
function dashboard(id, fData){
    ...
    function histoGram(fD){
        ...
        bars.append("rect")
            ...
            .attr('fill',barColor)
            .on("mouseover",mouseover)// mouseover is defined bewater.
            .on("mouseout",mouseout);// mouseout is defined bewater.
        ...
        function mouseover(d){  // utility function to be called on mouseover.
            // filter for selected Flight.
            var st = fData.filter(function(s){ return s.Flight == d[0];})[0],
        ...
        if(screen.width < 376) { // ik weet dat ik alleen de eerste regel heb aangepast, maar met zo'n ingewikkelde functie wilde ik het zekere voor het onzekere nemen haha
            ...
            function mouseover(d){
                ...
                hG.update(fData.map(function(v){ 
                    return [v.Flight,v.freq[d.data.type]];}),segColor(d.data.type));
            }
            //Utility function to be called on mouseout a pie slice.
            function mouseout(d){
                // call the update function of histogram with all data.
                hG.update(fData.map(function(v){
                    return [v.Flight,v.total];}), barColor);
            }
    ...
    // calculate total frequency by segment for all Flight.
    var tF = ['water','food','air'].map(function(d){ 
        return {type:d, freq: d3.sum(fData.map(function(t){ return t.freq[d];}))}; 
    });    
    
    // calculate total frequency by Flight for all segment.
    var sF = fData.map(function(d){return [d.Flight,d.total];});
